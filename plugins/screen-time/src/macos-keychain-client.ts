...
import { resolveMacosHelperExecutable } from "./macos-helper.js";
...
function helperFailure(error: unknown): ProviderError {
  ...
  if (candidate?.code === "ENOENT") {
    return new ProviderError("KEYCHAIN_UNAVAILABLE", "Keychain helper is unavailable", 503);
  }
