...
export function createPluginMigrationRunner(databaseUrl: string): PluginMigrationRunner {
  return async (pluginId, migrations) => {
...
export const runPluginMigrations: PluginMigrationRunner = (pluginId, migrations) =>
  createPluginMigrationRunner(getDbUrl())(pluginId, migrations);
